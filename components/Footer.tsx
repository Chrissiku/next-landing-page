...
const Footer = () => {
  return (
    <footer className="bg-[#0b1120] pt-10 lg:pt-[80px] relative z-10 ">
          ...
          <div className="w-full sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12 px-4">
            <div className="w-full mb-10">
              <a href="/" className="inline-block max-w-[160px] mb-6">
                <img src="logo-white.svg" alt="logo" className="max-w-full" />
              </a>
              ...
              <ul className="flex flex-wrap items-center">
                <li>
                  <a
                    ...
                    target="_blank"
                    className="block mb-6 mr-5 max-w-[120px] xl:max-w-[100px] 2xl:max-w-[120px]"
                  >
                ...
                <li>
                  <a
                    ...
                    className="block mb-6 mr-5 max-w-[120px] xl:max-w-[100px] 2xl:max-w-[120px]"
                  >
                    <img src="ecommerce-html.svg" alt="ecommerce-html" />
                  </a>
                </li>
                <li>
                  <a
                    ...
                    className="block mb-6 mr-5 max-w-[120px] xl:max-w-[100px] 2xl:max-w-[120px]"
                  >
                    <img src="graygrids.svg" alt="graygrids" />
                  </a>
                </li>
                <li>
                  <a
            ...
            <div className="w-full md:w-1/3 lg:w-1/2 px-4">
              <div className="flex justify-center md:justify-end my-1">
                <p className="text-base text-[#f3f4fe]">
                  ...
                  <a
                    href="https://vercel.com/chrissiku"
                    rel="nofollow noopner"
                    target="_blank"

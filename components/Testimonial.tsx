      ...
      <div className="container px-4">
        ...
        <div className="flex flex-wrap">
          <div className="w-full md:w-1/2 lg:w-1/3 px-4">
            <div className="ud-single-testimonial p-8 bg-white mb-12 shadow-testimonial ">
              ...
              <div className="ud-testimonial-info flex items-center">
                <div className="ud-testimonial-image w-[50px] h-[50px] rounded-full overflow-hidden mr-5">
                  <img src="author-01.png" alt="author" />
                </div>
                <div className="ud-testimonial-meta">
                  <h4 className="text-sm font-semibold">John Doe</h4>
                  <p className="text-[#969696] text-xs">Founder @ Play</p>
                </div>
              </div>
            </div>
          </div>
          <div className="w-full md:w-1/2 lg:w-1/3 px-4">
            <div className="ud-single-testimonial p-8 bg-white mb-12 shadow-testimonial ">
              ...
              <div className="ud-testimonial-info flex items-center">
                <div className="ud-testimonial-image w-[50px] h-[50px] rounded-full overflow-hidden mr-5">
                  <img src="author-02.png" alt="author" />
                </div>
                <div className="ud-testimonial-meta">
          ...
          <div className="w-full md:w-1/2 lg:w-1/3 px-4">
            <div className="ud-single-testimonial p-8 bg-white mb-12 shadow-testimonial ">
              ...
              <div className="ud-testimonial-info flex items-center">
                <div className="ud-testimonial-image w-[50px] h-[50px] rounded-full overflow-hidden mr-5">
                  <img src="author-03.png" alt="author" />
                </div>
                <div className="ud-testimonial-meta">
          ...
          <div className="w-full mx-4">
            <div>
              <div className="ud-title mb-8">
                <h6 className="text-xs font-normal text-body-color relative inline-flex items-center">
                  Some Of Our Clients
